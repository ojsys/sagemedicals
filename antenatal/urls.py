...
urlpatterns = [
    ...
    path("archive/",                               views.ANCArchiveView.as_view(),          name="archive"),
    ...
    path("<int:pk>/conclude/",                     views.ANCConcludeView.as_view(),         name="conclude"),
    path("<int:pk>/reopen/",                       views.ANCReopenView.as_view(),           name="reopen"),

...
@admin.register(User)
class UserAdmin(SuperuserForceDeleteMixin, BaseUserAdmin):
    ...
    # ------------------------------------------------------------------
    # Non-superuser delete → deactivate instead of hard-delete
    # ------------------------------------------------------------------
    ...
    def delete_view(self, request, object_id, extra_context=None):
        ...
        if request.method == "POST":
            ...
            self.message_user(
                request,
                f"User '{obj.email}' has been deactivated. Clinical records are preserved.",
        ...
        return TemplateResponse(request, "admin/accounts/user/deactivate_confirmation.html", context)
    ...
    def delete_queryset(self, request, queryset):
        ...
        self.message_user(
            request,
            f"{count} user(s) deactivated. Clinical records are preserved.",
            level=messages.WARNING,
        )
